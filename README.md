...
- **Экспорт и импорт JSON** — кнопки внизу страницы. Импорт сливает резервную копию с текущими данными без дублей (по тем же LWW-правилам, что и синхронизация); живая запись из бэкапа восстанавливает случайно удалённую.
